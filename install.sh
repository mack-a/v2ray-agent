...
menu() {
    ...
    echoContent green "官方网站：https://sywl6688.top"
    echoContent green "描述：时屿网络超级脚本\c"
    showInstallStatus
    checkWgetShowProgress
    echoContent red "\n=========================== 推广区============================"
    echoContent red "                                              "
    echoContent yellow "时屿网络特价活动"
    echoContent green "https://sywl6688.top/buy/55"
    echoContent yellow "TikTok直播推荐套装"
    echoContent green "https://sywl6688.top/buy/52"
    echoContent yellow ""
    echoContent green ""
    echoContent yellow ""
    echoContent red "=============================================================="
